...
export let inquirySchema = object({
  ...
  email: string().email("Email is required").required('Email is required'),
  message: string().required("Message is required").min(5, "Message must be at least 5 characters long"),
...
export const signupSchema = object().shape({
  ...
  password: string().min(6, "Password must contain minimum 6 latters.")
