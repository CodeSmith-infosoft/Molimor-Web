  ...
  return (
    <>
      ...
      <div className="hidden max-md:flex border border-[#E5E7EB] rounded-[5px]">
        <div className="relative flex-1 border-r border-[#E5E7EB]">
          <div
            className="flex max-mobile:justify-center justify-between max-mobile:gap-[10px] gap-10 cursor-pointer items-center py-[14px] px-5 max-mobile:px-[14px]"
            onClick={() =>
              setOpenFilter((prev) => ({ ...prev, category: !prev.category }))
            }
          >
