    ...
    <div className="w-full bg-white fixed z-20 top-0">
      ...
      <div className="mt-5">
        <div className="max-w-[1576px] px-10 max-lg:px-5 mx-auto flex items-center justify-between">
          ...
          {/* Location */}
          <div className="flex gap-[10px] max-md:hidden items-center text-sm text-gray-600">
            <svg
              width="26"
              height="26"
              viewBox="0 0 26 26"
          ...
          {/* Right side icons */}
          <div className="flex flex-col justify-between max-md:h-[66px]">
            ...
            <div className="flex items-center max-md:gap-4 gap-6">
              ...
              >
                ...
                <div className="flex items-center text-sm  text-gray-700 hover:text-gray-900 relative ">
      ...
      <div className="hidden max-md:block mt-6 mb-4">
