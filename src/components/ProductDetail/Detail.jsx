    ...
    <div className="">
      <div className="bg-white">
        ...
        <div className="mb-[14px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2  text-gray-700">
            <ul className="list-disc list-inside space-y-1">
              {Object.values(productData.keyBenefits)
            ...
            <ul className="list-disc list-inside space-y-1">
              {Object.values(productData.keyBenefits)
                ...
                .map((benefit, index) => (
                  <li key={`benefit2-${index * 2 + 1}`}>{benefit}</li>
                ))}
            </ul>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4 mb-[14px]">
          ...
          <button className=" bg-green cursor-pointer py-[14px] px-[30px] flex hover:bg-green text-white rounded-md">
        ...
        <div className="flex items-center space-x-[10px] text-sm text-gray-700 hover:text-gray-900 cursor-pointer">
          ...
          <span className="text-[16px] font-semibold">Share this Product</span>
        </div>
      </div>
    </div>
  );
