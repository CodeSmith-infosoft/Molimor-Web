        ...
        >
          ...
          {isOpen && (
            <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 rounded-md shadow-lg z-10 min-w-[160px]">
              ...
              >
                <img src={"/images/footer/watsapp.svg"} className="h-4" alt="" /> Share on WhatsApp
              </button>
              <button
                onClick={() =>
                  window.open(
              ...
              >
                <img src={"/images/footer/facebook.png"} className="h-4" alt="" /> Share on Facebook
              </button>
              ...
              <button
                ...
                className="flex gap-2 w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
              >
                <img src={"/images/footer/x.png"} className="h-4" alt="" /> Share on Twitter
              </button>
              ...
              >
                <img src={"/images/footer/link.svg"} className="h-4" alt="" /> Copy Link
              </button>
            </div>
          )}
        </div>
